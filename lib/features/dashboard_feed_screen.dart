...
// Stories row â†’ posts feed with photo, video, poll, article post types.
// Includes: pull-to-refresh, double-tap heart animation, follow button,
// suggested-trainer cards injected between posts.
// =============================================================================
...
class HomeFeedPageState extends State<HomeFeedPage> {
  ...
  // Suggested trainer card injected after post index 2
  ...
  void _vote(int postId, int optIdx) {
    setState(() {
      ...
      (p['options'] as List)
          .asMap()
          .forEach((i, o) => o['selected'] = i == optIdx);
      ...
      child: ListView(
        ...
        children: [
                ...
                if (s['isSelf'] == true) {
                  return _AddStoryBubble(
                    ...
                    onTap: () => AppUtils.showToast(
                        context, 'Story creation coming soon'),
                  );
                }
                return _StoryBubble(
                    story: s,
          ...
          for (int i = 0; i < _posts.length; i++) ...[
            ...
            // Inject "Suggested for You" card after a specific post
        ...
        Row(children: [
          ...
          Expanded(
              child: Column(
                ...
                Text(_suggested['specialty'],
                    style: const TextStyle(
                        color: AppTheme.textSecondary, fontSize: 12)),
                const SizedBox(height: 1),
                Text(_suggested['followers'],
                    style: const TextStyle(
...
class _AddStoryBubble extends StatelessWidget {
  ...
  const _AddStoryBubble(
      {required this.firstName, required this.lastName, required this.onTap});
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              border:
                  seen ? Border.all(color: AppTheme.divider, width: 2) : null,
            ),
            child: CircleAvatar(
                radius: 28,
          ...
          const SizedBox(height: 5),
          Text(story['name'].toString().split(' ')[0],
              style: TextStyle(
...
class _FeedPostState extends State<_FeedPost>
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      // -- Post content - double-tap to like on media -------------------
      GestureDetector(
        onDoubleTap: (post['type'] == 'photo' || post['type'] == 'video')
            ? _handleDoubleTap
            : null,
      ...
      Padding(
        ...
        child: Row(children: [
          _actionBtn(
              ...
              post['liked'] == true ? AppTheme.error : AppTheme.textSecondary,
              widget.onLike),
          const SizedBox(width: 5),
          Text(_fmtNum(post['likes']),
              style:
                  const TextStyle(color: AppTheme.textSecondary, fontSize: 12)),
          const SizedBox(width: 18),
          _actionBtn(CupertinoIcons.chat_bubble, AppTheme.textSecondary,
              widget.onComment),
          const SizedBox(width: 5),
          Text('${post['comments']}',
              style:
          ...
          _actionBtn(
              ...
              post['saved'] == true ? AppTheme.brand : AppTheme.textSecondary,
              widget.onSave),
        ]),
      ),
      ...
      case 'video':
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Stack(alignment: Alignment.center, children: [
            ...
            Positioned(
                bottom: 10, left: 12, child: _badge('${post['views']} views')),
            Positioned(bottom: 10, right: 12, child: _badge(post['duration'])),
          ]),
        ]);
